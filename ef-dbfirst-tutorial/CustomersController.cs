...
namespace ef_dbfirst_tutorial
{
    public class CustomersController
    {
        ...
        {
            _context.Customers.Add(cust); //adds the customer to collection but not to the database
            var changes = await _context.SaveChangesAsync(); // actually puts it in the database
